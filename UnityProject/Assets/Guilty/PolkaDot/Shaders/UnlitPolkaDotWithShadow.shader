...
Shader "Guilty/UnlitPolkaDotWithShadow" {
    Properties {
    ...
    SubShader {
        ...
        Pass {
            ...
            fixed4 frag(v2f i) : SV_Target {
                ...
                float isInPixel = step(length((frac((float2(screenPos.x, (screenPos.y + ((step(0.5, fmod(abs(screenPos.x), 2.0)) * 0.5) * _Shift))) - 0.5)) - 0.5) * 2.0), _Radius);
